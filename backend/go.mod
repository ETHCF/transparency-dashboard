module github.com/ETHCF/transparency-dashboard/backend

go 1.24.6

require (
	github.com/ETHCF/ethutils v1.0.1
	...
	github.com/numbergroup/config v1.2.0
	github.com/numbergroup/errors v1.0.0
	github.com/numbergroup/server v1.1.0
